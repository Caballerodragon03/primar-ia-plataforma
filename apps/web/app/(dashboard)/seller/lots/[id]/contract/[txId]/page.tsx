  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">Contract — Sign as Seller</h1>
      ...
      <div className="bg-white rounded-card border border-border shadow-sm divide-y divide-border">
        <div className="p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-gray-500 mb-1">Seller (You)</p>
      ...
      {/* Seller sign action */}
      {!buyerSigned && (
        <div className="bg-gray-50 border border-gray-200 rounded-card p-5 text-center">
          <p className="text-sm text-gray-600">The buyer has not signed this contract yet. You will be able to sign once the buyer completes their signature.</p>
        </div>
      )}
